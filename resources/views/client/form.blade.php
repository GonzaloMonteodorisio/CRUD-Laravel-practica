    ...
    <div class="container py-5 text-center">
        ...
        @endif
            ...
            <div class="mb-3">
                ...
                {{-- old() mantiene el valor ingresado para que no se borre si hay algún error. ?? toma el name de $client si no hay valor previo. @ para que no de error en caso de que no haya ninguno de los dos (y deje el valor en blanco) --}}
